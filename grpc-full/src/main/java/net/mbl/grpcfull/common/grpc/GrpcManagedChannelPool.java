...
import net.mbl.grpcfull.common.collections.Pair;
import net.mbl.grpcfull.common.util.CommonUtils;
import net.mbl.grpcfull.common.util.WaitForOptions;
...
public class GrpcManagedChannelPool {
     ...
     */
    private static final class ManagedChannelHolder {
