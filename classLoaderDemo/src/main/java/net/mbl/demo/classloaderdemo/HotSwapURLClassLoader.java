...
public class HotSwapURLClassLoader extends URLClassLoader {  
    ...
    //工程class类所在的路径  
    public static String projectClassPath = "/projects/github/JavaDemoParent/classLoaderDemo/target/classes/";
   
    //所有的测试的类都在同一个包下  
    public static String packagePath = "net/mbl/demo/classloaderdemo/";
