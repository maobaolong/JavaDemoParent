...
public final class Constants {
  ...
  public static final long HELLO_CLIENT_SERVICE_VERSION = 1;

  public static final long UNKNOWN_SERVICE_VERSION = -1;

  public static final String HELLO_CLIENT_SERVICE_NAME = "HelloClient";

  public static final String LOGGER_TYPE = "demo.logger.type";
