...
public abstract class WebServer {
  ...
  public WebServer(String serviceName, InetSocketAddress address) {
    ...
    int webThreadCount = 1;//Configuration.getInt(PropertyKey.WEB_THREADS);
    ...
    File warPath = new File("/software/projects/AllIdeaProjects/gits/jaxrsdemo/src/main/webapp"/*Configuration.get(PropertyKey.WEB_RESOURCES)*/);
